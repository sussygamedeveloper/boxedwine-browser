    ...
    var flag_r = { isReadable: function() { return true; },
        ...
        function setConfiguration() {
            ...
            Config.isZlibEnabled = DEFAULT_ZLIB_ENABLED;//getZlibParameter();
            Config.bpp = DEFAULT_BPP;//getBitsPerPixel();
        }
        ...
        function getEmulatorParams() {
            ...
            if(Config.Program.length > 0){
                ...
                var xxdxdxd=Config.Program.split("\n");
                for(var i=0;i<xxdxdxd.length;i++)params.push(xxdxdxd[i]);
            }
